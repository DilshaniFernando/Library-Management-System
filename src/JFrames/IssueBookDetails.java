...
public class IssueBookDetails extends javax.swing.JFrame {
    ...
    public void setIssueBookDetailsToTable(){
        try{
            ...
            ResultSet rs = st.executeQuery("select * from issue_book_details where ststus = '"+"Pending"+"'");
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 90, 350, 5));
